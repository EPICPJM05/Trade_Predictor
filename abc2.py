...
# Plotting Function
def plot_trend(data, stock_name, metrics):
...
class TrendAnalysisApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Stock Trend Detection")
        ...
        self.timeframe_frame.pack(pady=10)
    ...
    def update_chart(self, timeframe):
        if self.data is not None:
            ...
            self.current_fig = plot_trend(filtered_data, self.stock_name, metrics)
